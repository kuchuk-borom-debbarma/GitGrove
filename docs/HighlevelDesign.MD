...
*   **Command:** (TUI Only) `Register Repo` selection.
*   **Action:**
...
*   **Command:** `git checkout <orphan-branch-name>` (e.g., `git checkout gg/main/serviceA`)
*   **Experience:**
...
*   **Command:** `git commit -m "Update login"`
*   **GGC Logic:**
...
*   **Command:** (Proposed/Future) `gg scope serviceA`
*   **Effect:**
